...
async def add_security_headers(request, call_next):
    ...
    response.headers["Content-Security-Policy"] = "default-src 'self' https: http:; style-src 'self' 'unsafe-inline' https: http:; script-src 'self' 'unsafe-inline' 'unsafe-eval' https: http:; img-src 'self' data: blob: http: https:; frame-ancestors 'none';"
    return response
